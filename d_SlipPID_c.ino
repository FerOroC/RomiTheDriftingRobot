...
class SlipPID_c {
  public:
    ...
    SlipPID_c(float P, float I, float D); 
...
SlipPID_c::SlipPID_c(float P, float I, float D)
{
  //Store the gains
  setGains(P, I, D);
  //Set last_millis
...
void SlipPID_c::printComponents() {
...
void SlipPID_c::setGains(float P, float I, float D) {
  Kp = P;
  Kd = D;
  Ki = I;
}

float SlipPID_c::update(float error) {
...
SlipPID_c LeftSlipPID(0, 0, 0);
SlipPID_c RightSlipPID(0, 0, 0);
